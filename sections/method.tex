...
\noindent\textbf{Packet- and IP-level fields}\\
\begin{tabular}{@{}p{0.45\linewidth}p{0.45\linewidth}@{}}
\texttt{frame.len, ip.len, ip.ttl, ip.proto} &
\texttt{ip.src, ip.dst}
\end{tabular}

\vspace{0.75em}
\noindent\textbf{TCP-level fields (connection dynamics)}\\
\begin{tabular}{@{}p{0.45\linewidth}p{0.45\linewidth}@{}}
\texttt{tcp.srcport, tcp.dstport, tcp.hdr\_len, tcp.flags, tcp.window\_size\_value, tcp.window\_size\_scalefactor} &
\texttt{tcp.time\_relative, tcp.time\_delta, tcp.analysis.initial\_rtt, tcp.analysis.bytes\_in\_flight, tcp.analysis.push\_bytes\_sent}
\end{tabular}

\vspace{0.75em}
\noindent\textbf{TLS record-layer fields}\\
\begin{tabular}{@{}p{0.45\linewidth}p{0.45\linewidth}@{}}
\texttt{tls.record.content\_type, tls.record.version, tls.record.length} &
\texttt{tls.record.opaque\_type, tls.app\_data}
\end{tabular}

\vspace{0.75em}
\noindent\textbf{TLS handshake and extension fields}\\
\begin{tabular}{@{}p{0.45\linewidth}p{0.45\linewidth}@{}}
\texttt{tls.handshake.type, tls.handshake.version, tls.handshake.ciphersuite, tls.handshake.extensions\_length, tls.handshake.extension.type, tls.handshake.extensions.session\_ticket, tls.handshake.extensions.supported\_versions\_len, tls.handshake.extensions.supported\_version, tls.extension.psk\_ke\_modes\_length, tls.extension.psk\_ke\_mode} &
\texttt{tls.handshake.extensions\_key\_share\_client\_length, tls.handshake.extensions\_key\_share\_group, tls.handshake.extensions\_ec\_point\_formats\_length, tls.handshake.extensions\_supported\_groups\_length, tls.handshake.extensions\_supported\_group, tls.handshake.extensions\_alpn\_len, tls.handshake.extensions\_alpn\_str\_len, tls.handshake.extensions\_alpn\_str, tls.handshake.sig\_hash\_alg}
\end{tabular}
